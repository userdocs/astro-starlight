...
<Details summary=" target architectures" client:only="react">
...
This is done using <Tips client:only>Debian crossbuild essentials:crossbuild-essentials</Tips> or <Tips client:only>Musl Cross make toolchains:musl-cross-make</Tips>, depending on the host build platform.

Taking advantage of <Tips client:only>Github Workflows:github-workflows</Tips> it has been designed to easily forked and reused. Fork it, customise it and build and release your own binaries.
</Advanced>
