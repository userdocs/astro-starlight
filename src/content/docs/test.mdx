...
This is done using <Modal id="crossbuild-essentials" label="Debian crossbuild essentials"/> or <Modal id="musl-cross-make" label="Musl Cross make toolchains"/>, depending on the host build platform.

Taking advantage of <Modal id="github-workflows" label="Github Workflows"/> it has been designed to easily forked and reused. Fork it, customise it and build and release your own binaries.
